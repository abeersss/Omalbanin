    ...
    <div className="mx-auto max-w-2xl px-4 py-16 leading-8">
      ...
      {l === "ar" ? (
        <div className="space-y-4 text-[var(--ink)]">
          ...
          <p>نحرص على تمييز المصدر لكل نص: مصدر أساسي موثّق، أو حسب المنقول، أو محتوى محفوظ كما هو من الموقع الأصلي، أو محتوى بحاجة إلى تحقق. راجع صفحة المصادر لمزيد من التفاصيل.</p>
        </div>
      ) : (
        <div className="space-y-4 text-[var(--ink)]">
