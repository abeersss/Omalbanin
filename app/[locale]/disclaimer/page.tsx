    ...
    <div className="mx-auto max-w-2xl px-4 py-16 leading-8 text-[var(--ink)]">
      ...
      {l === "ar" ? (
        <div className="space-y-4">
          <p>يبذل هذا الموقع جهدًا لتمييز المصدر الديني لكل نص، والتفريق بين مصدر أساسي موثّق وممارسة شعبية متداولة ومحتوى بحاجة إلى تحقق. هذا التصنيف اجتهاد تنظيمي وليس فتوى شرعية.</p>
